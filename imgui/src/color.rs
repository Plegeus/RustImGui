...
impl Color {
  ...
  pub const DARK_GRAY: Color = Color([0.5, 0.5, 0.5, 1.0]);
  pub const LIGHT_GRAY: Color = Color([0.83, 0.83, 0.83, 1.0]);
  pub const BLACK: Color = Color([0.0, 0.0, 0.0, 1.0]);
  pub const RED: Color = Color([245.0 / 255.0, 39.0 / 255.0, 39.0 / 255.0, 1.0]);
  pub const DARK_RED: Color = Color([145.0 / 255.0, 20.0 / 255.0, 20.0 / 255.0, 1.0]);
  pub const LIGHT_RED: Color = Color([230.0 / 255.0, 108.0 / 255.0, 108.0 / 255.0, 1.0]);
  pub const GREEN: Color = Color([0.0, 1.0, 0.0, 1.0]);
  pub const BLUE: Color = Color([0.0, 0.0, 1.0, 1.0]);
  pub const LIGHT_BLUE: Color = Color([128.0 / 255.0, 210.0 / 255.0, 1.0, 1.0]);
